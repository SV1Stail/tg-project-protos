...
type PublisherClient interface {
	PublishScheduled(ctx context.Context, in *PublishScheduledRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	PublishNow(ctx context.Context, in *PublishNowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *publisherClient) PublishScheduled(ctx context.Context, in *PublishScheduledRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *publisherClient) PublishNow(ctx context.Context, in *PublishNowRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type PublisherServer interface {
	PublishScheduled(context.Context, *PublishScheduledRequest) (*emptypb.Empty, error)
	PublishNow(context.Context, *PublishNowRequest) (*emptypb.Empty, error)
...
func (UnimplementedPublisherServer) PublishScheduled(context.Context, *PublishScheduledRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PublishScheduled not implemented")
}
func (UnimplementedPublisherServer) PublishNow(context.Context, *PublishNowRequest) (*emptypb.Empty, error) {
...
var Publisher_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/publisher/publisher.proto",
}
